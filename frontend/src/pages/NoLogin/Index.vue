...
export default {
    meta: {
        link: [
            {
                href: { href: 'http://fonts.googleapis.com/css?family=Montserrat:400,700|Open+Sans:400italic,700italic,400,700', rel: 'stylesheet' }
            }
        ],
        script: {
		    { src: 'https://cdn.bootcss.com/jquery-mousewheel/3.1.13/jquery.mousewheel.min.js' }
        }
    },
    data() {
